...
def generate_unique_tai_khoan(existing_ids, nam):
    while True:
        nam_nhap_hoc = nam % 2000
...
def main():
    ...
    with open("insert_sinhvien.sql", "w", encoding="utf-8") as file:
        ...
        for i in range(1, 1001):
            ...
            nam_nhap_hoc = random.randint(2021, 2024)
            ...
            tai_khoan = generate_unique_tai_khoan(existing_ids, nam_nhap_hoc)
