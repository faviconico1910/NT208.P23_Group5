...
('K19','ATTT','CDTC1','Môn chuyên đề tốt nghiệp 1',7,4,0,NULL),
...
('K19','ATTT','NT522','Phương pháp học máy trong an toàn thông tin',2,1,NULL,'chuyên ngành'),

('K19','ATTT','NT541','Công nghệ mạng khả lập trình',3,1,NULL,'chuyên đề'),
('K19','ATTT','NT548','Công nghệ DevOps và ứng dụng',3,1,NULL,'chuyên đề'),